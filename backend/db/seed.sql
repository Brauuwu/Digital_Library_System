...
('Nguyễn Văn A','Tiểu sử tác giả Nguyễn Văn A. Xem: https://vi.wikipedia.org/Nguyen_Van_A'),
('Trần Thị B','Tiểu sử tác giả Trần Thị B. Xem: https://vi.wikipedia.org/Tran_Thi_B');
