...
const sequelize = new Sequelize('ThuVienSo','root','1234',{
  host: 'localhost',
  dialect: 'mysql',
  logging: false,
...
module.exports = { sequelize, User, Publisher, Book, Author, Category, AuthorBook, CategoryBook, Borrow, BorrowDetail };
